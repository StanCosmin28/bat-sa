...
const About = () => {
  ...
  return (
    <div className="bg-[#f8fafc] min-h-screen">
      {/* Header */}
      <div className="relative bg-[#0a101f] pt-32 pb-20 md:pt-40 md:pb-32 overflow-hidden">
        ...
        <div className="container mx-auto px-6 lg:px-12 relative z-10 text-center max-w-4xl">
          <AnimatedSection staggerChildren>
            <div className="inline-block mb-5 md:mb-6 px-4 py-1.5 rounded-full border border-white/10 bg-white/5 backdrop-blur-md">
              <span className="text-bat-gold font-bold tracking-widest uppercase text-xs">
                {t("about.kicker")}
              </span>
            </div>
            <h1 className="text-4xl sm:text-5xl md:text-7xl font-black mb-5 md:mb-8 tracking-tight text-white">
              {t("about.title")}
            </h1>
        ...
        <div className="container mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <AnimatedSection className="bg-white p-10 md:p-14 rounded-[2rem] shadow-sm border border-gray-100 flex flex-col justify-center">
              <h2 className="text-3xl font-bold text-bat-navy mb-6">
            ...
            <AnimatedSection
              delay={0.2}
              className="bg-bat-navy p-10 md:p-14 rounded-[2rem] shadow-xl relative overflow-hidden group"
            >
              ...
              <div className="relative z-10">
                ...
                <ul className="space-y-8">
                  <li className="flex gap-6">
                    ...
                    <div>
                      <strong className="block text-xl text-white mb-2">
                        {t("about.adv1Title")}
                      </strong>
      ...
      <section className="py-32 bg-white border-t border-gray-100">
        <div className="container mx-auto px-6 lg:px-12">
          <AnimatedSection className="text-center mb-20 max-w-3xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-black text-bat-navy tracking-tight mb-6">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <AnimatedSection key={i} delay={i * 0.1} className="h-full">
                <div className="group h-full flex flex-col items-center justify-center bg-[#f8fafc] border border-gray-100 p-10 rounded-[2rem] text-center hover:bg-bat-navy transition-colors duration-500 hover:shadow-2xl">
                  <div className="w-16 h-16 mx-auto bg-white rounded-2xl flex items-center justify-center text-bat-navy group-hover:text-bat-gold group-hover:bg-white/10 transition-colors duration-500 mb-6 shadow-sm shrink-0">
                    {industry.icon}
                  </div>
                  <h3 className="font-bold text-xl text-bat-navy group-hover:text-white transition-colors duration-500">
                    {industry.name}
                  </h3>
                </div>
              </AnimatedSection>
      ...
      <section className="py-32 bg-bat-blue text-center">
        <div className="container mx-auto px-6">
          <AnimatedSection>
            ...
            <Link
              to="/products"
              className="inline-flex items-center gap-3 bg-[#0a101f] hover:bg-gray-900 text-white font-bold py-4 px-10 rounded-full transition-all transform hover:scale-105 shadow-xl"
            >
